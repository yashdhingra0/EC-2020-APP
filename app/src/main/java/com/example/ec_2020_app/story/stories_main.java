package com.example.ec_2020_app.story;
...
public class stories_main extends AppCompatActivity {
    ...
    public static void goNextFrame(int previndex){
        ...
        if(current_index>=links.size()){
            ...
            final fragment_story fr = fragment_story.newInstance(links.size(), current_index, allIndex[current_index], links.get(current_index),"Manan, The TechnoSurge","Today 00:00 a.m.");
